...
import { PaginationDemo } from "../paginations/Paginations";
  ...
  return (
    <>
      <div className="container mt-5 position-relative">
                ...
                <div className="grid grid-cols-7 gap-2  border-b">
                  ...
                  <div className="px-4 py-4">
                    <Dropdown>
                      ...
                      <Dropdown.Menu>
                        <Dropdown.Item
                          onClick={() => handleChangeStatus(_id, "Active")}
                        >
                          Active
                        </Dropdown.Item>
                        <Dropdown.Item
                          onClick={() => handleChangeStatus(_id, "Inactive")}
                        >
                          InActive
                        </Dropdown.Item>
                      </Dropdown.Menu>
                    ...
                    <Dropdown>
                      ...
                      <Dropdown.Menu>
                        ...
                        <Dropdown.Item>
                          ...
                          >
                            <MdDelete size={20} className="text-red-800" />{" "}
                            Delete
                          </div>
                        </Dropdown.Item>
                      </Dropdown.Menu>
        ...
        <div className="mt-2 absolute right-1 cursor-pointer">
...
// remember no need to create everything from scratch but slightly logic gets change react bootstrap
